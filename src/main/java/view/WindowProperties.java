...
public abstract class WindowProperties {
    ...
    public static final int CITIES_LIMIT = 10;
    ...
    public static final String DESCRIPTION_TEXT = "Traveling Salesman Problem means given a list of cities and" +
    ...
    public static final int RESULT_TEXT_SIZE = 10;
    public static final Color RESULT_TEXT_COLOR = Color.BLACK.brighter();
    public static final Color RESULT_BORDER_COLOR = Color.BLACK.brighter();
    public static final String RESULT_TEXT_FONT = "Verdana";
    ...
    public static final int VOYAGER_DIAGONAL = 8;
    public static final int ANIMATION_DELAY = 2;
    public static final int ANIMATION_DURATION = 6;
